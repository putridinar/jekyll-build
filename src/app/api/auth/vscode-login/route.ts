    ...
    try {
        ...
        if (!userSnap.exists && role) {
            ...
            if (!querySnapshot.empty) {
                ...
                await existingUserDoc.ref.update({ userId: userId });
            }
        }
